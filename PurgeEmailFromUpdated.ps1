...
$complianceSearchName = Read-Host -Prompt 'Enter the Compliance Search Name (e.g., PurgeByFromEmail)'

# Prompt the user for the From email address
$fromEmail = Read-Host -Prompt 'Enter the From email address to search for (e.g., user@domain.com)'

# Create ContentMatchQuery with From email
$contentMatchQuery = "from:$fromEmail"
